...
abstract class Notification {
  Widget build();
  Widget buildBluePrint(Widget leadingIcon, String text1, String text2,
      String text3, String text4, String time) {
    return Padding(
      padding: const EdgeInsets.all(MarginValue.small / 2),
      child: Row(
