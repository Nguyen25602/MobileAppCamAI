            ...
            children: [
              SizedBox(
                ...
                child: Container(
                  ...
                  child: Container(
                    margin:
                        EdgeInsets.symmetric(horizontal: MarginValue.medium),
                    child: Row(
                      ...
                      children: [
                        ...
                        Icon(
                          widget._requestItem.state.icon,
                      ...
                      Table(
                        children: [
                          TableRow(
                            children: [
                              TableCell(
                                  child: labelWithInformation("Thời gian",
                                      "${dateTimetoString(widget._requestItem.startDate)} - ${dateTimetoString(widget._requestItem.endDate)}")),
                              TableCell(
                                  child: labelWithInformation("Loại nghỉ phép ",
                                      widget._requestItem.typeOff.formatString,
                                      margin: MarginValue.small))
                            ],
                          ),
                          TableRow(children: [
                            SizedBox(
                            ...
                            children: [
                              ...
                              TableCell(
                                child: labelWithInformation(
                                    "Lý do", widget._requestItem.reason,
                                    margin: MarginValue.small),
                              )
                            ],
                          )
