...
class NotificationPage extends StatefulWidget {
  ...
  List<StaffNotification> staffNotifications = [
    CheckInNotification(checkIn: CheckIn(date: DateTime.now())),
    RequestNotification(request: Request(name: "Trần Thiên Tường", start: DateTime(2023,7,15), end: DateTime(2023,7,25), type: TimeOffType.hasSalary, reason: "Ốm", state: StateOFRequest.accept)),
    RequestNotification(request: Request(name: "Trần Thiên Tường", start: DateTime(2023,7,15), end: DateTime(2023,7,25), type: TimeOffType.hasSalary, reason: "Ốm", state: StateOFRequest.reject)),
    CheckInNotification(checkIn: CheckIn(date: DateTime.now())),
    CheckInNotification(checkIn: CheckIn(date: DateTime.now())),
  ];
