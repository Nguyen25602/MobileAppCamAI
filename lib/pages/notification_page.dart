...
class NotificationPage extends StatefulWidget {
  ...
  final List<StaffNotification> staffNotifications = [
    CheckInNotification(
        checkIn: CheckIn(date: DateTime.now(), device: TypeDevice.camera)),
    RequestNotification(
        request: Request(
            name: "Trần Thiên Tường",
            start: DateTime(2023, 7, 15),
            end: DateTime(2023, 7, 25),
    ...
    CheckInNotification(
      checkIn: CheckIn(date: DateTime.now(), device: TypeDevice.gps),
    ),
    CheckInNotification(
        checkIn: CheckIn(date: DateTime.now(), device: TypeDevice.wifi)),
  ];
        ...
        bottom: PreferredSize(
          ...
          child: Container(
            padding: const EdgeInsets.symmetric(
                horizontal: MarginValue.small, vertical: MarginValue.small),
        ...
        Container(
          child: ListView(
            padding: const EdgeInsets.only(
                top: MarginValue.small, bottom: MarginValue.small),
            children: ListTile.divideTiles(
                    color: Colors.red,
                    context: context,
                    tiles: listNotification)
                .toList(),
          ),
        ),
        Container(),
