...
class DetailRequestPage extends StatelessWidget {
  const DetailRequestPage({super.key, required Request request}) : this._request = request;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        padding:const EdgeInsets.only(left: MarginValue.small, top: MarginValue.medium, right: MarginValue.small),
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              margin:const EdgeInsets.only(bottom: MarginValue.medium, top: MarginValue.medium),
      ...
      children: [
        TableRow(
          children: [
            ...
            _attribute(title: "Loại nghỉ phép", content: _request.typeOff.formatString),
          ]
        ),
        _tableSpacer(10),
        TableRow(
          children: [
            _attribute(title: "Thời gian", content: _request.formatEndDateAndStartDate()),
            const SizedBox()
          ]
        ),
        _tableSpacer(10),
        TableRow(
          children: [
            ...
            _attribute(title: "Số ngày nghỉ", content: _request.numberOfLeavingDay.toString())
          ]
        )
      ],
    );
